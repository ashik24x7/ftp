        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add Sub Menu</div>
                </div>
                <div class="portlet-body form">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <form action="{{url('/admin/sub-menu')}}" class="form-horizontal" method="post">
                    {{csrf_field()}}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">Select Main Menu</label>
                                <div class="col-md-6">
                                    <select class="form-control input-circle" name="main_menu" required>
                                    {{$main_menu}}
