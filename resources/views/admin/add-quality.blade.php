        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add Movie Quality</div>
                </div>
                <div class="portlet-body form">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <form action="{{url('/admin/movie/quality')}}" class="form-horizontal" method="post">
                    {{csrf_field()}}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Menu Name: </label>
                                <div class="col-md-6">
                                    <input type="text" name="quality" class="form-control input-circle" placeholder="Enter text">
