            ...
            <div class="page-content-wrapper">
              ...
              if(isset($_SESSION["infoError"]) && !empty($_SESSION["infoError"]) == true){  
               ...
               ?>
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
										...
										<?php $json =AllMovies(0);
									     foreach($json as $jsonm)
										 {
											 echo '<tr>';
											
				echo $title = "<td><img src='images/".$jsonm['MovieID']."/poster/".$jsonm['poster']."' width='75px' height='100px'/> &nbsp;&nbsp;".$jsonm['MovieTitle'].' ['.$jsonm['MovieYear'].']</td>';					 
				...
				<td>
				<a href="<?php echo URL.'/themes/'.THEME.'/single-movie.php?imdbid='.$jsonm['MovieID'];?>" target="_blank" class="btn btn-primary" data-toggle="tooltip" title="View" ><i class="fa fa-eye"></i></a>
				...
				<td><a href="action/trash.php?id=<?php echo $jsonm['MovieID']; ?>" class="btn btn-warning delete" data-toggle="tooltip" title="delete"><i class="fa fa-trash"></i></a></td>
