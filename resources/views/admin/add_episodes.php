        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> ADD TV SERIES EPISODES
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
										...
										?>
                                            <tr>
                                                ...
                                                <td> <a href="addepisodes.php?tvid=<?php echo $jsonm['TVID']; ?>" class="btn btn-primary" data-toggle="tooltip" title="" data-original-title="Add Episodes"><i class="fa fa-plus"></i> Add Episodes</a> </td>
                                                <td>
