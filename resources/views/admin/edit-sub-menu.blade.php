        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Edit Sub Menu</div>
                </div>
                <div class="portlet-body form">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <form action="{{url('/admin/submenu/edit',$submenu->id)}}" class="form-horizontal" method="post">
                    {{csrf_field()}}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">Select Main Menu</label>
                                <div class="col-md-6">
                                    <select class="form-control input-circle" name="main_menu" id="main_menu" required>
                                    {{$main_menu}}
                                    ...
                                    <span class="help-block">{{ $errors->first('main_menu') }}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Sub Menu Name: </label>
                                <div class="col-md-6">
                                    <input type="text" name="menu_name" class="form-control input-circle" placeholder="Enter sub menu name" value="{{$submenu->menu_name}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="drive" class="form-control input-circle" placeholder="fs1/movies" value="{{$submenu->drive}}" required>
...
@section('footer')
    ...
    <script>
		var main_menu = '{{$submenu->main_menu}}';
		$('#main_menu option').each(function() {
			var option = $(this).val();
			if(option == main_menu){
