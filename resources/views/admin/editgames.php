...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Fileserver | All Games Information</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> View All Games
              ...
              if(isset($_SESSION["infoError"]) && !empty($_SESSION["infoError"]) == true){  
               ...
               ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i> All Games </div>
                                    <div class="tools"> </div>
                                </div>
				...
				<a class="btn purple btn-outline sbold" href="action/ungames.php?id=<?php echo $allGames['id']; ?>" data-toggle="modal" title="unpublished"> <i class="fa fa-power-off"></i> </a>
				 </td>
