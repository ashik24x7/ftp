            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>All Unpublished Games</span>
                            </li>
                        </ul>
                        
                    </div>
                    <!-- END PAGE BAR --><br>
                    <!-- BEGIN PAGE TITLE--><a class="btn purple btn-outline sbold pull-right" href="action/ungames.php?allid=1" data-toggle="modal" title="published"> <i class="fa fa-undo"></i> Published All</a>
                    <h3 class="page-title"> View All Unpublished Games
              ...
              if(isset($_SESSION["infoError"]) && !empty($_SESSION["infoError"]) == true){  
               ...
               ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i> All Unpublished Games </div>
                                    <div class="tools"> </div>
                                </div>
				...
				<a class="btn purple btn-outline sbold" href="action/ungames.php?uid=<?php echo $allGames['id']; ?>" data-toggle="modal" title="published"> <i class="fa fa-undo"></i> </a>
				 </td>
				<td><a href="action/trashgames.php?id=<?php echo $allGames['id']; ?>" class="btn btn-warning delete" data-toggle="tooltip" title="delete"><i class="fa fa-trash"></i></a></td>
