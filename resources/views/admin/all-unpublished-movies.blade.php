<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Fileserver | All Unpublished Movies Information</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>All Unpublished Movies</span>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="page-title"> View All Unpublished Movies</h3>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i> All Unpublish Movies </div>
                                    <div class="tools"> </div>
                                </div>
                                    ...
                                    <table class="table" width="100%" id="" cellspacing="0" width="100%">
                                        ...
                                        @foreach($movies as $movie)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($movie->published == 0 ) No <a href="/admin/movie-publish/1/{{$movie->id}}" title=""><i class="fa fa-check-circle" style="font-size: 24px; color: green; margin-left: 5px; display: inline-block;" ></i></a>  @else Yes <a href="/admin/movie-publish/0/{{$movie->id}}" title=""><i class="fa fa-check-circle" style="font-size: 24px; color: red; margin-left: 5px; display: inline-block;" ></i></a>  @endif
