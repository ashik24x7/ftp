        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
              ...
              if(isset($_SESSION["infoError"]) && !empty($_SESSION["infoError"]) == true){  
               ...
               ?>
                    <h3 class="page-title"> Add Games (Manual)
					    ...
					    <div class="col-md-6 ">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <form role="form" action="action/addgames.php" role="form" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
										<div class="form-group">
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <input type="text" class="form-control" id="form_control_1" name="GamesTitle" />
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label has-error">
                                                <input type="text" class="form-control" id="form_control_1" name="YoutubeTrailer">
											...
											<div class="form-group form-md-line-input form-md-floating-label">
                                                <textarea class="form-control" rows="3" name="GamesDetails"></textarea>
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label has-info">
                                                <select class="form-control edited" id="form_control_1" name="GamesCate">
                                                    <option value=""></option>
                                                    <option value="1" selected>Select Games Category</option>
                                                    <?php menuRead('games'); ?>
                                                </select>
