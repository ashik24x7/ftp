...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Fileserver | Deleted Movies Information</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE--><br>
					<a href="action/deleteall.php?id" class="btn btn-danger delete" data-toggle="tooltip" title="" data-original-title="delete All"><i class="fa fa-trash"></i> All Delete Permanently</a>
					
					<a href="action/restore.php" class="btn purple btn-outline sbold pull-right" data-toggle="tooltip" title="" data-original-title="Restore All"><i class="fa fa-backward"></i> Restore All Movies</a>
                    
					<h3 class="page-title"> 
					View All Trash Movies   
                    </h3>
              ...
              if(isset($_SESSION["infoError"]) && !empty($_SESSION["infoError"]) == true){  
               ...
               ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i> All Trash Movies </div>
                                    <div class="tools"> </div>
                                </div>
                ...
                <?php $json =AllMovies(2);
									     foreach($json as $jsonm)
										 {
						if(empty($jsonm['MovieTitle']) !== true){					
				...
				echo "<td><p style='opacity:1;background:radial-gradient(#013100, #1F9A00); color:#fff; padding:3.3px; width:75px;text-align:center;font-size:14px;margin-left:5px;float:left;'>849 MB</p></td>";
				...
				<td><span class="label label-warning"><?php echo $jsonm['MovieTitle']; ?></span></td>
				<td>
				...
				<a class="btn purple btn-outline sbold" href="action/back.php?id=<?php echo $jsonm['MovieID']; ?>" data-toggle="tooltip" title="restore"> <i class="fa fa-backward"></i> </a>
				 </td>
				<td><a href="action/delete.php?id=<?php echo $jsonm['MovieID']; ?>" class="btn btn-danger delete" data-toggle="tooltip" title="delete"><i class="fa fa-trash"></i></a></td>
