        ...
        <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>All Unpublished Software</span>
                            </li>
                        </ul>
                        
                    </div>
                    <!-- END PAGE BAR --><br>
                    <!-- BEGIN PAGE TITLE--><a class="btn purple btn-outline sbold pull-right" href="action/ungames.php?allSid=1" data-toggle="modal" title="published"> <i class="fa fa-undo"></i> Published All</a>
                    <h3 class="page-title"> View All Unpublished Software
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i> All Unpublished Software </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
										 <tr>
										<?php $Software = AllSoftware(1);
										      foreach($Software as $Softwares){
										
			    $q = takeQuality($Softwares['cata']);
				echo "<td><img src=".URL.'/'.$Softwares['cover']." width=\"55px\" height=\"50px\"/> &nbsp;&nbsp;".$Softwares['title'].'</td>';					 
				echo "<td>".$q['menu_name']."</td>";
				echo "<td><span class=\"label label-warning\">".$Softwares['upby']."</span></td>";
				echo "<td>".$Softwares['filesize']."</td>";
				echo "<td>".substr($Softwares['downLink'],0,20)."</td>";
				?>
                                                
				
				<td>
				<a href="<?php echo URL.'/themes/'.THEME.'/Games/'.$Softwares['title'];?>" target="_blank" class="btn btn-primary" data-toggle="tooltip" title="View" ><i class="fa fa-eye"></i></a>
				<a class="btn purple btn-outline sbold" href="#large<?php echo $Softwares['id']; ?>" data-toggle="modal" title="Edit"> <i class="fa fa-edit"></i> </a>
				<a class="btn purple btn-outline sbold" href="action/ungames.php?uSid=<?php echo $Softwares['id']; ?>" data-toggle="modal" title="published"> <i class="fa fa-undo"></i> </a>
				 </td>
				<td><a href="action/trashgames.php?delSid=<?php echo $Softwares['id']; ?>" class="btn btn-warning delete" data-toggle="tooltip" title="delete"><i class="fa fa-trash"></i></a></td>
            ...
            <!-- END CONTENT -->
		   			...
		   			<?php $Software = AllSoftware(0);
										      foreach($Software as $Softwares){
										?>
		  <div class="modal fade bs-modal-lg" id="large<?php echo $Software['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h4 class="modal-title"><?php echo $Software['title']; ?></h4>
							</div>
										...
										<div class="form-group">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" style="width: 600px; height: 250px;">
													<img src="<?php echo URL.'/'.$Software['cover']; ?>" alt="" /> </div>
