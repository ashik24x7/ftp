        ...
        <div class="page-content">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <form action="{{url('/admin/menu/edit',$menu->id)}}" class="form-horizontal" method="post">
                    {{csrf_field()}}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Menu Name: </label>
                                <div class="col-md-3">
                                    <input type="text" name="menu_name" class="form-control input-circle" placeholder="Enter text" value="{{$menu->menu_name}}">
                                    <span class="help-block">{{ $errors->first('menu_name') }}</span>
                                </div>
                                <label class="col-md-1 control-label">icon: </label>
                                <div class="col-md-2">
                                    <input type="text" name="icon" class="form-control input-circle" placeholder="film" value="{{$menu->icon}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control input-circle" name="position" id="position">
                                    @for($i = $menu->position - 1; $i<= $menu->position + 1; $i++)
