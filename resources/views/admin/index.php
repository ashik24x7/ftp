        ...
        <div class="content">
		  ...
		  if(empty($_POST) === false){
			...
			if(empty($username) === true || empty($password)===true ){
			   $errors[] = 'Enter Username or password';
			}else if(user_exists($username) === false){
			    $errors[] = 'We can\'t find this username. have you register yet!';
			}else if(user_active($username) === false){
			   $errors[] = 'Sorry you are suspended';
			}else{
				...
				?>
				 <div class="alert alert-danger" style="display:block;">
                    ...
                    <span> 
                     ...
                     <?php echo output_errors($errors); ?></span>
                </div>
