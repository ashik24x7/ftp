							...
							<div class="cell-9">
								<div class="cell-12">
									<div class="product-specs price-block list-results">
										<div class="price-box"><span class="product-price">{{$game->name}}</span></div>
		    					...
		    					@endphp
									...
									<ul style="width:120%;">
									  <li><br>
									  <label class="control-label">Uploaded: <font color="#bbb"> {{$game->created_at->diffForHumans()}}</font></label>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="margin-top:150px;width: 700px;margin-left: -95px;">
		...
		<script type="text/javascript" charset="utf-8">
			...
			<script>
				var frameSrc = "http://43.230.123.21";
