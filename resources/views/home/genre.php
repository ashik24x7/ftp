...
<html>
	<head>
		...
		<title>– fileserver - <?php echo $movGenre; ?></title>
		<meta name="description" content="Fileserver – all <?php echo $movGenre; ?> Movies">
...
?>
				...
				.play-hover p:hover{
					...
					font-size:14px;
									...
									<?php $results = MoviesGenres($movGenre,$movCategory);
