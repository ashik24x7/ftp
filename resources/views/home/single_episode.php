...
$season = sanitize($_GET['s']);
$episode = sanitize($_GET['e']);
$results = SingleTVepisode($tvid,$season,$episode);
$json = singleTVseriesepisode($tvid,$season,$episode);
//$views = $results['views'];
//$views++;
							...
							<div class="cell-9">
								<div class="cell-12">
									<div class="product-specs price-block list-results">
										<div class="price-box"><span class="product-price"><?php echo $results['epTitle']; ?></span></div>
										<div>
											...
											<span><span>Episode : <?php echo $results['epEpisode']; ?> Season: <?php echo $results['epSeasons']; ?></span><span class="separator"></span>
										</div>
									</div>
									<div class="product-block results-avl list-results">
									  ...
									  poster="<?php if($results['epPoster'] != ''){echo "http://image.tmdb.org/t/p/w500/".$results['epPoster'];}else{echo 'images/d38bc38ad9ba60f9091aa2a9b3f4190f.png';}?>" data-setup="{}">
										<source src="<?php echo $results['epDownload']; ?>" type='video/mp4'>
										<source src="<?php echo $results['epDownload']; ?>" type='video/mkv'>
										<p class="vjs-no-js">
									...
									<div class="post-img">
									    <?php if($results['epPoster'] != ''){?>
				    						<img alt="" style="height:138px;" src="http://image.tmdb.org/t/p/w500/<?php  echo $results['epPoster']; ?>">
										<?php
										}else{
									...
									<div class="product-specs product-block list-results" style="margin-top:-17px;">
										...
										<span><i class="fa fa-film"></i><?php echo $results['epQuality']; ?></span></a>
									</div>
										<label class="control-label"><i class="fa fa-align-justify"></i>Quick Overview:</label>
				  <div class="show"><?php echo $results['epStory']; ?></div>
									</div>
									</div>
									</div>
									<div class="cell-3">
									<ul style="width:120%;">
									  <li><br>
									  <label class="control-label">Release Date: <font color="#bbb"> <?php echo $json['air_date']; ?></font></label>
									      
									  </li>
									  <li>
									  <label class="control-label">Episode: <font color="#bbb"> <?php echo $results['epEpisode']; ?> </font></label>
									  </li>
									  <li>
									  <label class="control-label">Season:<font color="#bbb"> <?php echo $results['epSeasons']; ?></font></label>
									  </li>
									   <li>
									  <label class="control-label">Runtime:<font color="#bbb"> 45 min</font></label>
									  </li>
									  <br>
									  <li>
									  <a class="btn btn-md btn-3d btn-blue fx animated fadeInUp" href="<?php echo $results['epDownload']; ?>" data-animate="fadeInUp" data-animation-delay="100" style="animation-delay: 100ms;">
			    ...
			    foreach($keyimages as $totalimages=>$keytotalimages){
				   ...
				   if($Totalbackdrops == 'file_path'){
					$Totalbackdropskeys
						...
						<img src="http://image.tmdb.org/t/p/w342/<?php echo $Totalbackdropskeys; ?>" alt=""style="width:100%;height:150px;">
						</a>
					</li>
								<?php  }
				   }
