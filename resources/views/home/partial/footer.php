			    ...
			    <div class="footer-bottom">
				    <div class="container">
			    		<div class="row">
				    		...
				    		<div class="copyrights cell-5">&copy; Copyrights <b> <?php echo WEBNAME; ?></b> <?php echo date('Y');?>. All rights reserved. <span><a href="#">DMCA</a> | <a href="#">Terms of use</a></span></div>
