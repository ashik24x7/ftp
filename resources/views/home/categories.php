...
?>
				...
				.play-hover p:hover{
					...
					font-size:14px;
									...
									<?php $results = MoviesCategory($movCategory,$start_from,$num_rec_per_page);
									...
									?>
											<li>
												<div class="post-img" style="max-height:70px inherit;" >
													<img src="../../Admin/main/images/<?php  echo $item2['MovieID'].'/poster/'.$item2['poster']; ?>" alt="<?php echo $item2['MovieTitle']; ?>" title="<?php echo $item2['MovieTitle']; ?>" />
												</div>
												<div class="widget-post-info">
													<h4 style="line-height:1.2;">
														<a href="single-movie.php?imdbid=<?php echo $item2['MovieID']; ?>" ><?php echo substr($item2['MovieTitle'],0,55).' ['.$item2['MovieYear'].']'; ?></a>
													</h4>
													<div class="meta">
													<span><?php echo $item2['MovieQuality']; ?></span>
													<span> | <?php echo ucfirst($item2['MovieCategory']); ?></span>
